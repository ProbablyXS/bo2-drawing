...
namespace AssaultCubeHack
{
    ...
    class Memory
    {
        ...
        /// </summary>
        public static Vector3 ReadFOOT(long baseAddress)
        {
        ...
        /// Read 3 consecutive floats into x,y,z of a Vector
        /// </summary>
        public static Vector3 ReadHEAD(long baseAddress, int PlayerIsCrouch)
        {
            //3 floats contiguously in memory
            byte[] buffer = new byte[3 * 4];
        ...
        internal static IntPtr OpenProcess(string mainWindowTitle)
        {
